...
namespace GenLibUnitTests.Extension
{
    public static class XunitShould
    {
        ...
        public static void ShouldBeEqualWithVariance(this double self, double other, double delta)
        {
            ShouldBeLessThanOrEqualTo(Math.Abs(Math.Abs(self) - Math.Abs(other)), delta);
        }
